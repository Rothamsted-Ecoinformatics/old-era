...
<p>R/EX/4 Residual effects of mineral fertilizer and manures applied
			1876-1901 and of additional phosphate applied since 1986, on the
			yield of spring barley (up to 1991) and winter wheat. A test of potassium
			was introduced in 2007. Soils now have a range of plant available P
and K.</p>
...
<li><A href="<?php echo $request; ?>#SEC2">Open Access data</A> </li>
</ul>
...
<p>For more details, refer to the <a href="home/Web_LTE_Guidebook_2018_2019-reprint.pdf">Rothamsted Guide to the Classical Experiments 2018</a> pages 34-35 and the Key References listed below.</p>
...
<p>Taken from the <i>Rothamsted Guide to the Classical Experiments</i> 1970, 1992 and 2019; Johnston & Poulton, 1977, Poulton et al, 2013 and Johnston et al, 2016.  </p>

<A NAME="SEC2"></a>
<H2>Data available</H2>
<p><a href="Exhaustion/exh_open_access_data" target="_blank">Open Access Data</a>: Exhaustion Land yields (spring barley and winter wheat) and assorted crop &amp; soil phosphate (P) data, 1974-2008, and metadata is available as a downloadable spreadsheet.
<p>For more details please contact the <a href="<?=$Era_Curator[Email]?>"target="_blank"> e-RA Curators</a>. 
