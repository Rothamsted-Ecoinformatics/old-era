...
if (!$LoggedIn)
{
  ...
  <input type="hidden" name="nbStep" value="<?=$nbStep?>">
    <p><b>Log in please</b></p>
        ...
        <p>or <a href="http://www.oregin.info/register.php">Register</p>
        </form>
...
if ($LoggedIn == "1")
{
   echo "<center><h3>$name is Logged on </h3>";
   echo "<p>Do you want to <a href='index.php?area=database&amp;page=indexdb&amp;log=out'>Logout</a>?</p>";
...
if ($LoggedIn == "-1")
{
   ...
   echo "<a href='index.php?area=database&amp;page=indexdb'>Login?</a>?";
