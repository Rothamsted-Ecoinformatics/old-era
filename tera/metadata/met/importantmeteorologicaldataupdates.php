...
<A NAME="SEC1"></a>
<h2>Rain</h2>
<p><b> RAIN (ROTHMET, WOBMET and BROOMET): Change of rain gauge and the effect on rainfall capture.</b> Rainfall was measured manually using a 5" (12.7cm) copper cylindrical rain gauge until the Met Stations at Rothamsted,
Woburn and Brooms Barn were automated in 2004 (Woburn in 1999). The 5" rain gauges were then replaced by automatic ARG100 tipping bucket rain gauges of 10" (25.4cm) diameter .
The manufacturers of the ARG100 state that the "ARG100 rain gauge typically captures over 5% more rainfall than most traditionally-shaped cylindrical gauges due to its unique aerodynamic shape and reduced
evaporation-loss properties". This has been found to be the case at Rothamsted, were rainfall in the 5" rain gauge continued to be measured on a twice weekly basis. The 5" gauges at Woburn and Brooms Barn ceased
to be used at the time of automation.</p>

<p>Knowing the above a review of the differences in rainfall capture between the ARG100 and the manual 5" gauge at Rothamsted was conducted. Using a double mass curve analysis, annual data from 1990-2017, and looking at each added
year from 2004 (when the ARG100 was introduced), the overall correction factor is 1.1 or 10%. This means that the ARG100 captures 10% more rainfall than the manual 5" gauge. This correction is only applicable
to annual and monthly totals, and to the variable RAIN at Rothamsted (ie ROTHMET only). It is not applicable to RAINL or RAIN5. To convert 5" data to ARG100 data, multiply by 1.1. To convert ARG100 data to 5",
divide by 1.1. We recommend that when you download data that spans both gauges, you multiply the 5" data by 1.1. Please contact the e-RA curators for more information. </p>
...
<A NAME="SEC4"></a>
<h2>Radiation</h2>
<p><b>RAD (ROTHMET): </b>Radiation data for <b>1949-1954</b> at Rothamsted should be treated with caution, as it appears to be around 20% higher than would be expected.
See <A HREF="http://www.era.rothamsted.ac.uk/Met/instrumentdescription#SEC5" target="_blank">Solar radiation measurements</A>for further details. 
