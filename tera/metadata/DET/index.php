...
<h1>The Data Extraction Tool (DET)</h1>
<p>
</p>
...
<p><a href="http://www3.rothamsted.ac.uk/cdera/extract/pages/data_extraction_prototype6.html" target="_blank">Extract Data</a> shows the current datasets.<br />
  Contact the <a href="mailto:era@rothamsted.ac.uk" target="_blank">e-RA Curators</a> to arrange a password for the database (DET).<br />
  Login to the database (<a href="http://www3.rothamsted.ac.uk/cdera/extract/pages/data_extraction_prototype6.html#user_session" target="_blank">DET</a>) tool. <br />
  <br />
<A NAME="SEC1"></a></p>
<H2>Background</H2>
