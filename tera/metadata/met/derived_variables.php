...
<LI class="nicelist"><A href="<?php echo $request; ?>#DDA"><B>DDA</B></A>:	Day Degrees Above a base temperature (TLIM) (ºC)	</li>
<LI class="nicelist"><A href="<?php echo $request; ?>#DDB"><B>DDB</B></A>:	Day Degrees Below a base TLIM	(ºC)</li>
<LI class="nicelist"><A href="<?php echo $request; ?>#ACDDA"><B>ACCDDA</B></A>:	Accumulated Day Degrees Above TLIM	(ºC)</li>
<LI class="nicelist"><A href="<?php echo $request; ?>#ACDDB"><B>ACCDDB</B></A>:	Accumulated Day Degrees Below TLIM	(ºC)</li>
...
<LI class="nicelist"><A href="<?php echo $request; ?>#TLIM"><B>TLIM</A>:</B>	The (arbitrary) limiting or base temperature (set by user) (ºC)	</li>
...
<p>TRANGE = TMAX - TMIN   : Range (ºC) </p>

<a name="AVTEMP"></a>
<p>AVTEMP = (TMAX+TMIN)/2 : Average temperature (ºC) </p>
...
<p>If TMIN > = TLIM then <B>DDB</B> = 0 in (ºC)</p>
