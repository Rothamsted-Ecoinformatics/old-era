...
<form
	...
	<table>
		<tr>
			<td width="300px"><p>You need to extract the following data from eRA
				...
				<ul>
					...
					<li>RAIN: Rainfall in 24h, 0900GMT to 0900GMT (mm)</li>
					<li>SUN:</li>
					<li>RAD:</li>
					<li>WINDRUN:</li>
				</ul></td>
